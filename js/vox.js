...
var Vox = function() {
    ...
    Vox.prototype.LoadFile = function(name, filename, type, funcptr) {
        console.log("Load file:", name, filename, type);
        ...
        if (data) {
            ...
            while(i < buffer.length) {
                ...
                if(id == "SIZE") {
                    ...
                    var numthisels = Math.abs(this.readInt(buffer, i));
                    i += 4;
                    voxelData = new Array(numthisels);
